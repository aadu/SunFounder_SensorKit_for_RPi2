...
class BMP280:
    ...
    _BUS_1_TYPES = ['Pi 3 Model B', 'Pi 3 Model B', 'Pi 2 Model B', 'Pi2 Model B', 'Model B+']
    ...
    def read(self):
        ...
        var2 = (raw_temp / 131072.0 - self.dig_T1 / 8192.0
               ) * (raw_temp / 131072.0 - self.dig_T1 / 8192.0) * self.dig_T3  # formula for temperature from datasheet
        ...
        ) / 524288.0  # formula for pressure from datasheet
